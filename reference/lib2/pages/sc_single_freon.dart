...
class ScSingleFreon extends StatelessWidget {
  ScSingleFreon({super.key});
              ...
              child: Column(
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      _buildOutLineButton('F160V', onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>
                                  const ReportPage(model_id: 7)),
                        );
                      }),
                      _buildOutLineButton(
                        'F170J',
    ...
    return SizedBox(
      ...
      child: OutlinedButton(
        ...
        style: OutlinedButton.styleFrom(
          side: BorderSide(color: const Color(0xFFAD193C), width: 1.5),
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(6.r),
          ),
