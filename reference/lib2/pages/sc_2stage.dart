...
class Sc2stage extends StatelessWidget {
  const Sc2stage({super.key});
              ...
              child: Column(
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      _buildOutLineButton('N1612C', onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>
                                  const ReportPage(model_id: 24)),
                        );
                      }),
                      _buildOutLineButton('F1612C', onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>
                                  const ReportPage(model_id: 28)),
                        );
                      }),
                      _buildOutLineButton('N2016C', onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>
                                  const ReportPage(model_id: 25)),
                        );
                      }),
                      _buildOutLineButton('F2016C', onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>
                                  const ReportPage(model_id: 29)),
                        );
                      }),
                      _buildOutLineButton('N2520C', onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>
                                  const ReportPage(model_id: 26)),
                        );
                      }),
                      _buildOutLineButton('F2520C', onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>
                                  const ReportPage(model_id: 30)),
                        );
                      }),
                      _buildOutLineButton('N3225C', onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>
                                  const ReportPage(model_id: 27)),
                        );
                      }),
                      _buildOutLineButton('F3225C', onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>
                                  const ReportPage(model_id: 31)),
                        );
                      }),
                    ],
                  ),
